...
class ConnectionWidget(QGroupBox):
    ...
    def _build_ui(self):
        ...
        # Page 1 — RunPod
        runpod_page = QWidget()
        rl = QVBoxLayout(runpod_page)
        rl.setContentsMargins(0, 0, 0, 0)
        rl.setSpacing(4)
        rl.addWidget(QLabel("API Key:"))
        ...
        rl.addWidget(self._key_edit)
        rl.addWidget(QLabel("Endpoint ID:"))
        ...
        rl.addWidget(self._ep_edit)
        self._stack.addWidget(runpod_page)
