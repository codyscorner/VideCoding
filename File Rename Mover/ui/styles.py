"""Theme and styling management for File Rename Mover application"""
...
class DarkRedTheme(Theme):
    ...
    def apply_to_style(self, style: ttk.Style) -> None:
        """Apply dark red theme to ttk.Style"""
...
class ThemeManager:
    ...
    def __init__(self, style: ttk.Style, theme_name: str = 'dark_red'):
        """
