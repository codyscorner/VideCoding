...
# PromptArchiver.spec — single-file windowed build.
# The shared VideCoding venv carries heavy ML packages the app never imports;
# they MUST stay excluded or the EXE balloons ~10x.
